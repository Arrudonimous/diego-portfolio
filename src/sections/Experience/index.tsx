...
export default function Experience() {
  return (
    <div className="md:flex md:flex-row md:items-center md:justify-center md:gap-20">
      <div className="flex flex-col mt-16 border-2 border-border rounded-lg px-5 pb-8 pt-14 text-white items-center justify-center md:w-1/4 md:h-[20rem] md:hover:bg-footer md:hover:border-0 transition-all duration-150">
